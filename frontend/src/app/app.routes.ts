...
import { SecurityGaurdComponent } from './components/Staff/SecurityGaurd/security-gaurd/security-gaurd.component';
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'apartments/SecurityGaurd',
        loadComponent: () =>
          import(
            './components/Staff/SecurityGaurd/security-gaurd/security-gaurd.component'
